...
# variable_index=1
# 
# cefas_dir='/home/ph290/data1/temp_data/cefas_data/'
...
# 
# moll_dir='/home/ph290/data1/temp_data/butler_data/'
...
# # 
# # hadsst_dir='/home/ph290/data1/temp_data/misc_data/'
...
# # 
# # #read in HadSST data
# # #sst_file='/home/ph290/data1/temp_data/misc_data/HadISST_sst.nc'
# # sst_file='/home/ph290/data1/temp_data/misc_data/HadSST.3.1.0.0.median.nc'
...
# '''
# 
# nao_data=np.genfromtxt('/home/ph290/data1/temp_data/misc_data/nao.dat')
...
# y_tmp=np.array(mollusk_gr[4][91:])
# moving_avg_val=10
# y2=movingaverage(np.array(mollusk_gr[4][91:]),moving_avg_val)
# y=y2[moving_avg_val/2:-moving_avg_val/2]
# y2=movingaverage(np.array(y_tmp),moving_avg_val)
# y=y2[moving_avg_val/2:-moving_avg_val/2]
# 
...
# for i in range(1):
#     loc[0][0]=np.where(rmse_log == sorted_rmse[4])[0][0]
...
# plt.show()
# 
# output = shelve.open('/home/ph290/data1/temp_data/output/my_shelf4.dat')
...
# 
# #and restore with:
# # input = shelve.open('/home/ph290/data1/temp_data/output/my_shelf.dat')
...
# and restore with:
input = shelve.open('/home/ph290/data1/temp_data/output/my_shelf4.dat')
rmse_log = input['rmse_log']
input_var1 = input['input_var1']
input_var2 = input['input_var2']
input_var3 = input['input_var3']
...
print 'Growth-rate model based on:\n'+var_name[np.int(variables_array1b[np.int(input_var1[loc[0]])])]+', '+var_name[np.int(variables_array1b[np.int(input_var2[loc[0]])])]+' and '+var_name[np.int(variables_array1b[np.int(input_var3[loc[0]])])]
# plt.ion()
...
fig0 = plt.figure(num=None, figsize=(7, 3), dpi=150, facecolor='w', edgecolor='k')
ax1 = fig0.add_subplot(1,1,1)
...
lns1 = ax1.plot(moll_yr_mv_avg2,moll_mv_avg3,'k', label = 'Bivalve growth rate (10yr smoothed)',linewidth=3)
ax1.set_ylabel('growth rate (normalised)', fontsize=18)
ax1.set_xlabel('year', fontsize=18)
lns2 = ax1.plot(yr1[moving_avg_val/2:-moving_avg_val/2],temp_2,'k--',label='Statistical model using\nSST, SSS and suspension feeders from 3D model',linewidth=3)
plt.ylim(0.45,1.2)
ax2 = ax1.twinx()
lns3 = ax2.plot(yr1[moving_avg_val/2:-moving_avg_val/2],o2,'r', label = '3D model\'s sea-bed O$_2$',linewidth=3)
plt.ylim(255,282.5)
...
lns = lns1+lns2+lns3
labs = [l.get_label() for l in lns]
ax1.legend(lns, labs, loc=3,prop={'size':tmp_font_size}).draw_frame(False)
...
fig. tight_layout()
# plt.show()
plt.savefig('/home/ph290/Desktop/delete3.pdf')
