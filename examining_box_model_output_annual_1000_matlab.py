...
source="/data/data1/ph290/boxmodel_testing_less_boxes_4_annual_matlab/results/order_runs_processed_in_box_model.txt"
inp = open(source,"r")
count=0
for line in inp:
    count +=1
...
'''
dir_name='/data/data1/ph290/boxmodel_testing_less_boxes_4_annual_matlab/results/'
...
param_file='/home/ph290/data1/data/piston_hypercube_7param_1000exp_wide_2013b.csv'
