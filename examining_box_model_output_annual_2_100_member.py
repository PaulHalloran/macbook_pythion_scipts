...
source="/net/project/obgc/boxmodel_testing_less_boxes_4_annual/results/order_runs_processed_in_box_model.txt"
inp = open(source,"r")
count=0
for line in inp:
    count +=1
...
param_file='/home/h04/hador/data/piston_hypercube_8param_100exp_wide_2013b.csv'
input_param=np.genfromtxt(param_file, delimiter=",")
params=input_param[:,[0,1,2,4,5,6,7,8]]
param_names=['piston (Sp)','piston (S)','piston (Eq)','alpha','mixing','box3 vol','box4 vol','fract to bx1 v. bx4']
