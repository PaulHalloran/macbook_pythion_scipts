...
dir1='/net/project/obgc/boxmodel_testing_less_boxes_4_monthly_inclusing_vol_params/results/'
filenames=glob.glob(dir1+'box_model_qump_results_80.csv')
input1=np.genfromtxt(filenames[0], delimiter=",")
box_co2_flux=np.zeros(array_size)
box_years=input1[:,0]
box_co2_flux[:]=input1[:,1]

'''
'''

dir2='/net/project/obgc/boxmodel_testing_less_boxes_4_monthly_inclusing_vol_params/results2/'
filenames2=glob.glob(dir2+'box_model_qump_results_80.csv')
input2=np.genfromtxt(filenames2[0], delimiter=",")
box_co2_flux2=np.zeros(array_size)
box_years2=input2[:,0]
box_co2_flux2[:]=input2[:,1]
