...
for i,loc in enumerate(even_indices):
	...
	for k in np.arange(3):
		ln_tmp=plt.plot(qump_year,(box_co2_flux[:,best[i],0,k]/1.12e13)*1.0e15/12.0,label=plot_names2[k])
...
for i,loc in enumerate(odd_indices):
	...
	for k in np.arange(3):
		ln_tmp=plt.plot(qump_year,(box_co2_flux[:,worst[i],0,k]/1.12e13)*1.0e15/12.0,label=plot_names2[k])
